...
public class GetItemByIdApiTest extends ApiTestBase {
    ...
    void tc41_successGetItemByExistingId() {
        ...
        assertEquals(createdItem.id(), requiredText(item, "id", "TC-41"),
    ...
    void tc47_repeatGetByIdShouldReturnStableData() {
        ...
        assertEquals(firstItem, secondItem, "[TC-47] Два GET-ответа для одного id должны быть идентичными");
    }
    ...
    void tc64_getByIdWithCorrectAcceptHeader() {
        ...
        assertEquals(200, response.statusCode(), "[TC-64] Ожидался статус 200 с Accept: application/json");
