...
public class E2EApiFlowTest extends ApiTestBase {
  ...
  void tc77_createThenGetByIdSellerAndStatistic() {
    ...
    assertEquals(
        200, statisticResponse.statusCode(), "[E2E-01] GET /statistic/{id} должен вернуть 200");
