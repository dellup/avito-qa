...
public final class PathScenarioProvider {
  ...
  public static Stream<PathScenario> invalidItemIdCases() {
    return Stream.of(
        ...
        new PathScenario(
            "TC-45",
            "Получение объявления с невалидным форматом идентификатора (пробелы)",
            "   ",
            400),
        new PathScenario(
            "TC-46",
            "Получение объявления с невалидным форматом идентификатора (спецсимволы)",
            "!@#$%^&*",
            400));
  }
  ...
  public static Stream<PathScenario> invalidStatisticIdCases() {
    return Stream.of(
        ...
        new PathScenario(
            "TC-61", "Получение статистики с невалидным форматом идентификатора", "boba", 400));
  }
}
